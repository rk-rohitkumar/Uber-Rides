...
See `Measures_Reference.md` for the full list of calculated KPIs and their exact DAX definitions.

## Report Visual Mapping
Visuals are linked to specific JSON files found in the report definition path (e.g., `PBIP/Uber Rides.Report/definition/pages/*/visuals/*.json`).
