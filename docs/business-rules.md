...
3. **Data Profile Constraints:** All data imported from external sources (CSV files under `DataSource/`) must conform to the constraints defined in their respective Data Profiles (e.g., `DataProfile_Rides.csv`, `DataProfile_Locations.csv`).
